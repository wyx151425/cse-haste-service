...
CREATE TABLE `cse_leadership_score_form` (
  ...
  `complete` bit(1),
  `complete_at` datetime,
  `politics_quality_1` int(2),
  `politics_quality_2` int(2),
  `politics_quality_3` int(2),
  `operate_performance_1` int(2),
  `operate_performance_2` int(2),
  `operate_performance_3` int(2),
  `operate_performance_4` int(2),
  `teamwork_1` int(2),
  `teamwork_2` int(2),
  `teamwork_3` int(2),
  `style_and_image_1` int(2),
  `style_and_image_2` int(2),
  `style_and_image_3` int(2),
  `evaluator_id` int(11),
