...
public interface LeaderCadreScoreFormRepository extends HasteRepository<LeaderCadreScoreForm, Integer> {
    ...
    /**
     * 根据考核评价工作组ID和评分完成情况查询领导干部评价评分表
     *
     * @param evaluationGroupId 考核评价工作组ID
     * @param complete          评分完成情况
     * @return 领导干部评价评分表数据集合
     */
    List<LeaderCadreScoreForm> findAllByEvaluationGroupIdAndComplete(
     ...
     * @return 领导干部考核评价表
     */
    List<LeaderCadreScoreForm> findAllByEvaluationGroupIdAndEvaluateeId(
